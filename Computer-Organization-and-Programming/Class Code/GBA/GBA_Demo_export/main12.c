...
int main() {
	...
	int sawUp = 0, sawDown = 0, upDown = 0, downDown = 0;
		...
		sawUp =  KEY_DOWN_NOW(BUTTON_UP) == 0 && upDown;
		upDown = KEY_DOWN_NOW(BUTTON_UP) != 0;
		sawDown = KEY_DOWN_NOW(BUTTON_DOWN) == 0 && downDown;
		downDown = KEY_DOWN_NOW(BUTTON_DOWN) != 0;
